...
CREATE TABLE POSSIBLE_CLASSES (
    POSSIBLE_CLASSES_ID VARCHAR(20) not null,
    TITLE VARCHAR(20) NOT NULL references CLASSES(TITLE)
);

CREATE TABLE LECT_DATE(
	LECT_DATE_ID VARCHAR(20) NOT NULL,
	LECT_DATE VARCHAR(20),
	CONSTRAINT PK_LECT_DATE_ID PRIMARY KEY(LECT_DATE_ID)
);

CREATE TABLE DIS_DATE(
	DIS_DATE_ID VARCHAR(20) NOT NULL,
	DIS_DATE VARCHAR(20),
	CONSTRAINT PK_DIS_DATE_ID PRIMARY KEY(DIS_DATE_ID)
);

CREATE TABLE LAB_DATE(
	LAB_DATE_ID VARCHAR(20) NOT NULL,
	LAB_DATE VARCHAR(20),
	CONSTRAINT PK_LAB_DATE PRIMARY KEY(LAB_DATE_ID)
);
...
CREATE TABLE LABS (
	...
	LAB_DATE VARCHAR(20) NOT NULL references LAB_DATE(LAB_DATE_ID), 
...
CREATE TABLE SECTION (
	...
	TITLE VARCHAR(20) NOT NULL references CLASSES(TITLE), 
	COURSE_NO VARCHAR(20) NOT NULL references COURSES(COURSE_NO),
	LECT_DATE_ID VARCHAR (20) NOT NULL references LECT_DATE,
	DIS_DATE_ID VARCHAR (20) NOT NULL references DIS_DATE,
	BUILDING VARCHAR(20) NULL, 
	ROOM VARCHAR(20)  NULL,
	MAXCAP INT NULL,
	LAB_ID VARCHAR(20) references LABS(LAB_ID),
...
CREATE TABLE CATEGORY_DEGREE(
    ...
    CONSTRAINT PK_LIST PRIMARY KEY (CATEG_DEGREE_ID)
);
