...
CREATE TABLE PREREQ_LIST(
    ...
    CONSTRAINT PK_PLIST PRIMARY KEY(PREREQID)
);

CREATE TABLE PREREQ_COURSES(
   PID INT NOT NULL, 
   PREREQID INT NOT NULL references PREREQ_LIST(PREREQID), 
   P_COURSES VARCHAR(20) NOT NULL, 
   CONSTRAINT PK_PCOURSES PRIMARY KEY(PID)
);


CREATE TABLE COURSES(
    CID VARCHAR(20) NOT NULL,
    PREREQID VARCHAR(20) NOT NULL references PREREQ_LIST(PREREQID),
    UNITS INT NOT NULL,
...
CREATE TABLE UNDERGRADUATES (
	...
	TITLE VARCHAR(20)  references MINOR(TITLE),
