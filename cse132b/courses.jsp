        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            ...
                            "Grade = ?, Lab_Req = ?, prereq = ? WHERE Course_No = ?");
                        ...
                        pstmt.setInt(6, Integer.parseInt(request.getParameter("Course_No")));
                        int rowCount = pstmt.executeUpdate();
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        pstmt.setInt(
                            1, Integer.parseInt(request.getParameter("Course_No")));
                        int rowCount = pstmt.executeUpdate();
            ...
            %>
                    ...
                    <tr>
                        ...
                        <form action="courses.jsp" method="get">
                            ...
                            <input type="hidden" 
                                value="<%= rs.getInt("Course_No") %>" name="Course_No">
                            <%-- Button --%>
                            <td>
